...
The Hebrew word for "tree" or "wood." Can refer to living trees or to timber used for construction.
...
That which is SEEN (Ayin) and ESTABLISHED (Tzade). The Etz is the visible structure that captures and holds. A tree "captures" nutrients from the soil and "holds" its position in the earth. This makes it a perfect symbol for both LIFE (a living tree) and DEATH (an execution tree).
...
Used by Moses to describe the horror of public execution. Applied by David to describe the righteous person. Reinterpreted by Paul and Peter to describe Christ's substitutionary death.
